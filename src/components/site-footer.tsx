...
export function SiteFooter() {
  return (
    <footer className="mt-auto border-t border-slate-800/90 bg-slate-950">
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 sm:py-12">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          <div className="lg:col-span-2">
            <Link href="/" className="inline-flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-slate-100">ReviewFlow AI</p>
        ...
        <div className="mt-12 flex flex-col gap-3 border-t border-slate-800/80 pt-8 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-wrap gap-4 text-xs text-slate-600">
            <Link href="/auth" className="transition hover:text-slate-400">
              Sign in
            </Link>
